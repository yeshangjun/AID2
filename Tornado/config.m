...
switch input
   ...
   case 'startup'
       ...
       output.acdir=strcat(pwd,'/Tornado/aircraft');             %aircraft directory 
       output.afdir=strcat(pwd,'/Tornado/aircraft/airfoil');     %airfoil directory 
       output.sdir=strcat(pwd,'/Tornado/state');                 %state directory 
       output.odir=strcat(pwd,'/Tornado/output');                %output file directory
       output.pdir=strcat(pwd,'/Tornado/polars');                %polars directory %***
       output.xfldir=strcat(pwd,'/Tornado/aircraft/airfoil/XFL');%Xfoil database directory
